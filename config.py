...
class TrainConfig:
    ...
    spatial_downsample: int = 1                 # train on every N-th pixel spatially; infer/evaluate on the full grid
    time_stride: int = 20                       # sample every N-th timestep (1 = all frames, 2 = every other frame, etc.)
    mask_npz: str = ""                          # optional split/mask artifact generated by scripts/make_masks_splits.py
